...
public class AllVerticesIteratorTest extends TestLogger {

	@Test
	public void testAllVertices() throws JobException {
		...
		AllVerticesIterator iter = new AllVerticesIterator(Arrays.asList(ejv1, ejv2, ejv3, ejv4)
				.iterator());
