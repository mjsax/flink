...
public class ExecutionVertexCancelTest extends TestLogger {
	...
	@Test
	public void testCancelFromCreated() throws JobException {
	...
	@Test
	public void testCancelFromScheduled() throws JobException {
		final JobVertexID jid = new JobVertexID();
		final ExecutionJobVertex ejv = getExecutionVertex(jid);
	...
	@Test
	public void testRepeatedCancelFromRunning() throws Exception {
		final JobVertexID jid = new JobVertexID();
		final ExecutionJobVertex ejv = getExecutionVertex(jid, TestingUtils.directExecutionContext());
